...
HD_PWD='D:/Documents/GitHub/VIVADO_EN224-Test-et-verification/2_Hardware/Etape_7/vivado/vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PGCD_uart.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PGCD_uart.tcl
